...
import {
  Mail, Lock, Loader2, MessageSquare,
  Zap, Shield, Users, AlertCircle, Eye, EyeOff, ArrowRight,
} from "lucide-react";
...
const FEATURES = [
  { icon: Zap,    title: "Instant real-time messaging", desc: "Zero-latency delivery via WebSocket" },
  { icon: Shield, title: "Secure & private",            desc: "Encrypted conversations you control" },
  { icon: Users,  title: "Groups & communities",        desc: "Stay connected with everyone" },
];
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative flex-col justify-between p-12 overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-purple-800">
        ...
        <div className="relative z-10 space-y-10">
          <div>
            <h2 className="text-4xl xl:text-[2.75rem] font-bold text-white leading-[1.1] tracking-tight">
              Connect with the
              <br />
              <span className="text-white/50">people that matter</span>
            </h2>
        ...
        <p className="relative z-10 text-white/25 text-xs">Join thousands of users already connected.</p>
      </div>
